--[[
	a modified version of the ZS derma skin.
	i like how this looks so i'm using it for flood as well.
]]
...
SKIN.PrintName = "Flood Derma Skin"
...
SKIN.Colours.Label = {}
SKIN.Colours.Label.Default				= Color(225, 225, 225, 235)
SKIN.Colours.Label.Bright				= Color(225, 225, 225, 235)
SKIN.Colours.Label.Dark					= Color(225, 225, 225, 235)
SKIN.Colours.Label.Highlight			= Color(225, 225, 225, 235)
...
function SKIN:PaintButton(panel, w, h) -- paints buttons.
	if not panel.m_bBackground then return end
...
function SKIN:PaintMenu(panel, w, h) -- this is primarily for painting the children of a combobox
	if not panel.m_bBackground then return end
	local col
...
function SKIN:PaintComboBox(panel, w, h) -- paints combo boxes
	if not panel.m_bBackground then return end
...
function SKIN:PaintTooltip(panel, w, h) -- paints tooltips when hovering over buttons/labels/whatever
	local col2 = Color(255, 255, 255, 220)
...
derma.DefineSkin("flood", "The default Derma skin for Flood", SKIN, "Default")
