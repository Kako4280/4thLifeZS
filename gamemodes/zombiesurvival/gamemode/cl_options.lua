...
GM.ViewModelPosition = math.Clamp(CreateClientConVar("zs_viewmodelposition", 1, true, false):GetFloat(), 0, 20)
cvars.AddChangeCallback("zs_viewmodelposition", function(cvar, oldvalue, newvalue)
	GAMEMODE.ViewModelPosition = math.Clamp(tonumber(newvalue) or 1, 0, 20)
end)

GM.ViewModelPosition2 = math.Clamp(CreateClientConVar("zs_viewmodelposition2", 1, true, false):GetFloat(), 0, 20)
cvars.AddChangeCallback("zs_viewmodelposition2", function(cvar, oldvalue, newvalue)
	GAMEMODE.ViewModelPosition2 = math.Clamp(tonumber(newvalue) or 1, 0, 20)
end)

GM.ViewModelPositionUp = math.Clamp(CreateClientConVar("zs_viewmodelpositionup", 1, true, false):GetFloat(), 0, 20)
cvars.AddChangeCallback("zs_viewmodelpositionup", function(cvar, oldvalue, newvalue)
	GAMEMODE.ViewModelPositionUp = math.Clamp(tonumber(newvalue) or 1, 0, 20)
end)

GM.ViewModelPositionDown = math.Clamp(CreateClientConVar("zs_viewmodelpositiondown", 1, true, false):GetFloat(), 0, 20)
cvars.AddChangeCallback("zs_viewmodelpositiondown", function(cvar, oldvalue, newvalue)
	GAMEMODE.ViewModelPositionDown = math.Clamp(tonumber(newvalue) or 1, 0, 20)
end)
