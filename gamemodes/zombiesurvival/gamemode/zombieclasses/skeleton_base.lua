CLASS.Name = "Skeleton Base"
CLASS.TranslationName = "class_skeletal_fiend"
...
CLASS.BetterVersion = "Brittle Skeletal Walker"
...
CLASS.Points = CLASS.Health/GM.SkeletonPointRatio * 1.5

CLASS.SWEP = "weapon_zs_skeleton_base"
	...
	function CLASS:ProcessDamage(pl, dmginfo)
		...
		if dmginfo:GetInflictor().IsMelee then
			if IsValid(attacker) then
				local dmgReflected = math.Round(dmginfo:GetDamage() * self.MeleeDamageReflection / 100 * math.Rand(0.5, 2), 0)
