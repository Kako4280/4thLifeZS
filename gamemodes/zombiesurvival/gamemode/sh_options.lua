...
GM.AmmoCache["alyxgun"]						= 48		-- Not used.
GM.AmmoCache["pistol"]						= 40		-- Pistols.
GM.AmmoCache["smg1"]						= 80		-- SMG's and some rifles.
GM.AmmoCache["357"]							= 20		-- Rifles, especially of the sniper variety.
GM.AmmoCache["xbowbolt"]					= 24		-- Crossbows
GM.AmmoCache["buckshot"]					= 32		-- Shotguns
...
GM.AmmoCache["battery"]						= 50		-- Used with the Medical Kit.
GM.AmmoCache["gaussenergy"]					= 6		-- Nails used with the Carpenter's Hammer.
...
GM.AmmoCache["repairfield_nanite"]			= 1
GM.AmmoCache["zapper"]						= 1
GM.AmmoCache["pulse"]						= 60
...
GM.AmmoResupply = table.ToAssoc({"ar2", "pistol", "smg1", "357", "xbowbolt", "buckshot", "battery", "pulse", "impactmine", "chemical", "gaussenergy", "sniperround", "scrap"})
...
GM:AddStartingItem("2pcp",				ITEMCAT_AMMO,			8,				nil,			"32 pistol ammo",				nil,		"ammo_pistol",			function(pl) pl:GiveAmmo(32, "pistol", true) end)
GM:AddStartingItem("3pcp",				ITEMCAT_AMMO,			12,				nil,			"48 pistol ammo",				nil,		"ammo_pistol",			function(pl) pl:GiveAmmo(48, "pistol", true) end)
GM:AddStartingItem("2pcp",				ITEMCAT_AMMO,			16,				nil,			"64 pistol ammo",				nil,		"ammo_pistol",			function(pl) pl:GiveAmmo(64, "pistol", true) end)
GM:AddStartingItem("3pcp",				ITEMCAT_AMMO,			20,				nil,			"80 pistol ammo",				nil,		"ammo_pistol",			function(pl) pl:GiveAmmo(80, "pistol", true) end)
GM:AddStartingItem("2sgcp",				ITEMCAT_AMMO,			8,				nil,			"24 shotgun ammo",				nil,		"ammo_shotgun",			function(pl) pl:GiveAmmo(24, "buckshot", true) end)
GM:AddStartingItem("3sgcp",				ITEMCAT_AMMO,			12,				nil,			"36 shotgun ammo",				nil,		"ammo_shotgun",			function(pl) pl:GiveAmmo(36, "buckshot", true) end)
GM:AddStartingItem("2sgcp",				ITEMCAT_AMMO,			16,				nil,			"48 shotgun ammo",				nil,		"ammo_shotgun",			function(pl) pl:GiveAmmo(48, "buckshot", true) end)
GM:AddStartingItem("3sgcp",				ITEMCAT_AMMO,			20,				nil,			"60 shotgun ammo",				nil,		"ammo_shotgun",			function(pl) pl:GiveAmmo(60, "buckshot", true) end)
GM:AddStartingItem("2smgcp",			ITEMCAT_AMMO,			8,				nil,			"80 SMG ammo",					nil,		"ammo_smg",				function(pl) pl:GiveAmmo(80, "smg1", true) end)
GM:AddStartingItem("3smgcp",			ITEMCAT_AMMO,			12,				nil,			"120 SMG ammo",					nil,		"ammo_smg",				function(pl) pl:GiveAmmo(120, "smg1", true) end)
GM:AddStartingItem("2smgcp",			ITEMCAT_AMMO,			16,				nil,			"160 SMG ammo",					nil,		"ammo_smg",				function(pl) pl:GiveAmmo(160, "smg1", true) end)
GM:AddStartingItem("3smgcp",			ITEMCAT_AMMO,			20,				nil,			"200 SMG ammo",					nil,		"ammo_smg",				function(pl) pl:GiveAmmo(200, "smg1", true) end)
GM:AddStartingItem("2arcp",				ITEMCAT_AMMO,			8,				nil,			"64 assault rifle ammo",		nil,		"ammo_assault",			function(pl) pl:GiveAmmo(64, "ar2", true) end)
GM:AddStartingItem("3arcp",				ITEMCAT_AMMO,			12,				nil,			"96 assault rifle ammo",		nil,		"ammo_assault",			function(pl) pl:GiveAmmo(96, "ar2", true) end)
GM:AddStartingItem("2arcp",				ITEMCAT_AMMO,			16,				nil,			"128 assault rifle ammo",		nil,		"ammo_assault",			function(pl) pl:GiveAmmo(128, "ar2", true) end)
GM:AddStartingItem("3arcp",				ITEMCAT_AMMO,			20,				nil,			"160 assault rifle ammo",		nil,		"ammo_assault",			function(pl) pl:GiveAmmo(160, "ar2", true) end)
GM:AddStartingItem("2rcp",				ITEMCAT_AMMO,			8,				nil,			"16 rifle ammo",				nil,		"ammo_rifle",			function(pl) pl:GiveAmmo(16, "357", true) end)
GM:AddStartingItem("3rcp",				ITEMCAT_AMMO,			12,				nil,			"24 rifle ammo",				nil,		"ammo_rifle",			function(pl) pl:GiveAmmo(24, "357", true) end)
GM:AddStartingItem("2rcp",				ITEMCAT_AMMO,			16,				nil,			"32 rifle ammo",				nil,		"ammo_rifle",			function(pl) pl:GiveAmmo(32, "357", true) end)
GM:AddStartingItem("3rcp",				ITEMCAT_AMMO,			20,				nil,			"40 rifle ammo",				nil,		"ammo_rifle",			function(pl) pl:GiveAmmo(40, "357", true) end)
GM:AddStartingItem("2pls",				ITEMCAT_AMMO,			8,				nil,			"60 pulse ammo",				nil,		"ammo_pulse",			function(pl) pl:GiveAmmo(60, "pulse", true) end)
GM:AddStartingItem("3pls",				ITEMCAT_AMMO,			12,				nil,			"90 pulse ammo",				nil,		"ammo_pulse",			function(pl) pl:GiveAmmo(90, "pulse", true) end)
GM:AddStartingItem("2pls",				ITEMCAT_AMMO,			16,				nil,			"120 pulse ammo",				nil,		"ammo_pulse",			function(pl) pl:GiveAmmo(120, "pulse", true) end)
GM:AddStartingItem("3pls",				ITEMCAT_AMMO,			20,				nil,			"150 pulse ammo",				nil,		"ammo_pulse",			function(pl) pl:GiveAmmo(150, "pulse", true) end)
GM:AddStartingItem("xbow1",				ITEMCAT_AMMO,			8,				nil,			"16 crossbow bolts",			nil,		"ammo_bolts",			function(pl) pl:GiveAmmo(16, "XBowBolt", true) end)
GM:AddStartingItem("xbow2",				ITEMCAT_AMMO,			12,				nil,			"24 crossbow bolts",			nil,		"ammo_bolts",			function(pl) pl:GiveAmmo(24, "XBowBolt", true) end)
GM:AddStartingItem("xbow1",				ITEMCAT_AMMO,			16,				nil,			"36 crossbow bolts",			nil,		"ammo_bolts",			function(pl) pl:GiveAmmo(36, "XBowBolt", true) end)
GM:AddStartingItem("xbow2",				ITEMCAT_AMMO,			20,				nil,			"48 crossbow bolts",			nil,		"ammo_bolts",			function(pl) pl:GiveAmmo(48, "XBowBolt", true) end)
GM:AddStartingItem("4mines",			ITEMCAT_AMMO,			8,				nil,			"8 explosives",					nil,		"ammo_explosive",		function(pl) pl:GiveAmmo(8, "impactmine", true) end)
GM:AddStartingItem("6mines",			ITEMCAT_AMMO,			12,				nil,			"12 explosives",				nil,		"ammo_explosive",		function(pl) pl:GiveAmmo(12, "impactmine", true) end)
GM:AddStartingItem("4mines",			ITEMCAT_AMMO,			16,				nil,			"16 explosives",				nil,		"ammo_explosive",		function(pl) pl:GiveAmmo(16, "impactmine", true) end)
GM:AddStartingItem("6mines",			ITEMCAT_AMMO,			20,				nil,			"20 explosives",				nil,		"ammo_explosive",		function(pl) pl:GiveAmmo(20, "impactmine", true) end)
GM:AddStartingItem("8nails",			ITEMCAT_AMMO,			8,				nil,			"8 nails",						nil, 		"ammo_nail", 			function(pl) pl:GiveAmmo(8, "GaussEnergy", true) end)
GM:AddStartingItem("12nails",			ITEMCAT_AMMO,			12,				nil,			"12 nails",						nil, 		"ammo_nail", 			function(pl) pl:GiveAmmo(12, "GaussEnergy", true) end)
GM:AddStartingItem("8nails",			ITEMCAT_AMMO,			16,				nil,			"16 nails",						nil, 		"ammo_nail", 			function(pl) pl:GiveAmmo(16, "GaussEnergy", true) end)
GM:AddStartingItem("12nails",			ITEMCAT_AMMO,			20,				nil,			"20 nails",						nil, 		"ammo_nail", 			function(pl) pl:GiveAmmo(20, "GaussEnergy", true) end)
GM:AddStartingItem("60mkit",			ITEMCAT_AMMO,			10,				nil,			"60 medical power",				nil,		"ammo_medpower",		function(pl) pl:GiveAmmo(60, "Battery", true) end)
GM:AddStartingItem("90mkit",			ITEMCAT_AMMO,			15,				nil,			"90 medical power",				nil,		"ammo_medpower",		function(pl) pl:GiveAmmo(90, "Battery", true) end)
GM:AddStartingItem("60mkit",			ITEMCAT_AMMO,			20,				nil,			"120 medical power",			nil,		"ammo_medpower",		function(pl) pl:GiveAmmo(120, "Battery", true) end)
GM:AddStartingItem("90mkit",			ITEMCAT_AMMO,			25,				nil,			"150 medical power",			nil,		"ammo_medpower",		function(pl) pl:GiveAmmo(150, "Battery", true) end)

GM:AddStartingItem("brassknuckles",		ITEMCAT_MELEE,			30,				"weapon_zs_brassknuckles").Model = "models/props_c17/utilityconnecter005.mdl"
GM:AddStartingItem("zpaxe",				ITEMCAT_MELEE,			30,				"weapon_zs_axe")
GM:AddStartingItem("crwbar",			ITEMCAT_MELEE,			30,				"weapon_zs_crowbar")
GM:AddStartingItem("stnbtn",			ITEMCAT_MELEE,			30,				"weapon_zs_stunbaton")
GM:AddStartingItem("csknf",				ITEMCAT_MELEE,			30,				"weapon_zs_swissarmyknife")
GM:AddStartingItem("zpplnk",			ITEMCAT_MELEE,			30,				"weapon_zs_plank")
...
GM:AddStartingItem("pipe",				ITEMCAT_MELEE,			30,				"weapon_zs_pipe")
GM:AddStartingItem("hook",				ITEMCAT_MELEE,			30,				"weapon_zs_hook")
GM:AddStartingItem("lamp",				ITEMCAT_MELEE,			30,				"weapon_zs_lamp")

local item
GM:AddStartingItem("medkit",			ITEMCAT_TOOLS,			30,				"weapon_zs_medicalkit")
GM:AddStartingItem("medgun",			ITEMCAT_TOOLS,			30,				"weapon_zs_medicgun")
GM:AddStartingItem("strengthshot",		ITEMCAT_TOOLS,			30,				"weapon_zs_strengthshot")
...
GM:AddStartingItem("junkpack",			ITEMCAT_DEPLOYABLES,	10,				"weapon_zs_boardpack")
...
GM:AddStartingItem("electrobattery",	ITEMCAT_TOOLS,			20,				"comp_electrobattery")
...
GM:AddStartingItem("barricadekit",		ITEMCAT_DEPLOYABLES,			60,				"weapon_zs_barricadekit")
GM:AddStartingItem("camera",			ITEMCAT_DEPLOYABLES,			15,				"weapon_zs_camera").Countables = "prop_camera"
GM:AddStartingItem("tv",				ITEMCAT_DEPLOYABLES,			20,				"weapon_zs_tv").Countables = "prop_tv"

GM:AddStartingItem("loadingframe",		ITEMCAT_TRINKETS,		10,				"trinket_loadingex").SubCategory =				ITEMSUBCAT_TRINKETS_PERFORMANCE
GM:AddStartingItem("processor",			ITEMCAT_TRINKETS,		15,				"trinket_processor").SubCategory =				ITEMSUBCAT_TRINKETS_SUPPORT
GM:AddStartingItem("vitpackagei",		ITEMCAT_TRINKETS,		15,				"trinket_vitpackagei").SubCategory =			ITEMSUBCAT_TRINKETS_DEFENSIVE
...
GM:AddStartingItem("pathfinder",		ITEMCAT_TRINKETS,		20,				"trinket_pathfinder").SubCategory=				ITEMSUBCAT_TRINKETS_PERFORMANCE
GM:AddStartingItem("acqmanifest",		ITEMCAT_TRINKETS,		20,				"trinket_acqmanifest").SubCategory=				ITEMSUBCAT_TRINKETS_SUPPORT
GM:AddStartingItem("mainsuite",			ITEMCAT_TRINKETS,		20,				"trinket_mainsuite").SubCategory=				ITEMSUBCAT_TRINKETS_SUPPORT
GM:AddStartingItem("blueprintsi",		ITEMCAT_TRINKETS,		20,				"trinket_blueprintsi").SubCategory=				ITEMSUBCAT_TRINKETS_SUPPORT
...
item.NoClassicMode = true
item =
GM:AddStartingItem("corfragment",		ITEMCAT_OTHER,			15,				"weapon_zs_corruptedfragment")
item.NoClassicMode = true
...
--item.SkillRequirement = SKILL_TECH_CADE_NANITE
...
-- Tier 2
GM:AddPointShopItem("glock3",			ITEMCAT_GUNS,			40,				"weapon_zs_glock3")
GM:AddPointShopItem("magnum",			ITEMCAT_GUNS,			40,				"weapon_zs_magnum")
GM:AddPointShopItem("eraser",			ITEMCAT_GUNS,			40,				"weapon_zs_eraser")
GM:AddPointShopItem("sawedoff",			ITEMCAT_GUNS,			40,				"weapon_zs_sawedoff")
GM:AddPointShopItem("uzi",				ITEMCAT_GUNS,			40,				"weapon_zs_uzi")
GM:AddPointShopItem("annabelle",		ITEMCAT_GUNS,			40,				"weapon_zs_annabelle")
GM:AddPointShopItem("inquisitor",		ITEMCAT_GUNS,			40,				"weapon_zs_inquisitor")
GM:AddPointShopItem("amigo",			ITEMCAT_GUNS,			40,				"weapon_zs_amigo")
GM:AddPointShopItem("hurricane",		ITEMCAT_GUNS,			40,				"weapon_zs_hurricane")
GM:AddPointShopItem("fracture",         ITEMCAT_GUNS,           40,             "weapon_zs_fracture")
GM:AddPointShopItem("redeemer",         ITEMCAT_GUNS,           40,             "weapon_zs_redeemers")
-- Tier 3
GM:AddPointShopItem("deagle",			ITEMCAT_GUNS,			80,				"weapon_zs_deagle")
GM:AddPointShopItem("tempest",			ITEMCAT_GUNS,			80,				"weapon_zs_tempest")
GM:AddPointShopItem("ender",			ITEMCAT_GUNS,			80,				"weapon_zs_ender")
GM:AddPointShopItem("shredder",			ITEMCAT_GUNS,			80,				"weapon_zs_smg")
GM:AddPointShopItem("silencer",			ITEMCAT_GUNS,			80,				"weapon_zs_silencer")
GM:AddPointShopItem("hunter",			ITEMCAT_GUNS,			80,				"weapon_zs_hunter")
GM:AddPointShopItem("onyx",				ITEMCAT_GUNS,			80,				"weapon_zs_onyx")
GM:AddPointShopItem("akbar",			ITEMCAT_GUNS,			80,				"weapon_zs_akbar")
GM:AddPointShopItem("oberon",			ITEMCAT_GUNS,			80,				"weapon_zs_oberon")
GM:AddPointShopItem("hyena",			ITEMCAT_GUNS,			80,				"weapon_zs_hyena")
GM:AddPointShopItem("pollutor",			ITEMCAT_GUNS,			80,				"weapon_zs_pollutor")
GM:AddPointShopItem("crossbow",			ITEMCAT_GUNS,			80,				"weapon_zs_crossbow")
GM:AddPointShopItem("enkindler",        ITEMCAT_GUNS,           80,             "weapon_zs_enkindler")
-- Tier 4
GM:AddPointShopItem("longarm",			ITEMCAT_GUNS,			160,			"weapon_zs_longarm")
GM:AddPointShopItem("sweeper",			ITEMCAT_GUNS,			160,			"weapon_zs_sweepershotgun")
GM:AddPointShopItem("jackhammer",		ITEMCAT_GUNS,			160,			"weapon_zs_jackhammer")
GM:AddPointShopItem("bulletstorm",		ITEMCAT_GUNS,			160,			"weapon_zs_bulletstorm")
GM:AddPointShopItem("reaper",			ITEMCAT_GUNS,			160,			"weapon_zs_reaper")
GM:AddPointShopItem("quicksilver",		ITEMCAT_GUNS,			160,			"weapon_zs_quicksilver")
GM:AddPointShopItem("slugrifle",		ITEMCAT_GUNS,			160,			"weapon_zs_slugrifle")
GM:AddPointShopItem("stalker",			ITEMCAT_GUNS,			160,			"weapon_zs_m4")
GM:AddPointShopItem("smelter",			ITEMCAT_GUNS,			160,			"weapon_zs_smelter")
GM:AddPointShopItem("inferno",			ITEMCAT_GUNS,			160,			"weapon_zs_inferno")
GM:AddPointShopItem("quasar",			ITEMCAT_GUNS,			160,			"weapon_zs_quasar")
GM:AddPointShopItem("barrage",			ITEMCAT_GUNS,			160,			"weapon_zs_barrage")
GM:AddPointShopItem("asmd",       	    ITEMCAT_GUNS,           160,            "weapon_zs_asmd")
GM:AddPointShopItem("charon",			ITEMCAT_GUNS,			160,			"weapon_zs_charon")
GM:AddPointShopItem("spinfusor",		ITEMCAT_GUNS,			160,			"weapon_zs_spinfusor")
-- Tier 5
GM:AddPointShopItem("artemis",			ITEMCAT_GUNS,			320,			"weapon_zs_artemis")
GM:AddPointShopItem("novacolt",			ITEMCAT_GUNS,			320,			"weapon_zs_novacolt")
GM:AddPointShopItem("bulwark",			ITEMCAT_GUNS,			320,			"weapon_zs_bulwark")
GM:AddPointShopItem("zeus",				ITEMCAT_GUNS,			320,			"weapon_zs_zeus")
GM:AddPointShopItem("juggernaut",		ITEMCAT_GUNS,			320,			"weapon_zs_juggernaut")
GM:AddPointShopItem("scar",				ITEMCAT_GUNS,			320,			"weapon_zs_scar")
GM:AddPointShopItem("boomstick",		ITEMCAT_GUNS,			320,			"weapon_zs_coomstick")
GM:AddPointShopItem("deathdlrs",		ITEMCAT_GUNS,			320,			"weapon_zs_deathdealers")
GM:AddPointShopItem("colossus",			ITEMCAT_GUNS,			320,			"weapon_zs_colossus")
GM:AddPointShopItem("renegade",			ITEMCAT_GUNS,			320,			"weapon_zs_renegade")
GM:AddPointShopItem("pulserifle",		ITEMCAT_GUNS,			320,			"weapon_zs_pulserifle")
GM:AddPointShopItem("gluon",			ITEMCAT_GUNS,			320,			"weapon_zs_gluon")
GM:AddPointShopItem("broadside",		ITEMCAT_GUNS,			320,			"weapon_zs_broadside")
GM:AddPointShopItem("innervator",		ITEMCAT_GUNS,			320,			"weapon_zs_innervator")
GM:AddPointShopItem("eminence",			ITEMCAT_GUNS,			320,			"weapon_zs_eminence")

GM:AddPointShopItem("pistolammo",		ITEMCAT_AMMO,			5,				nil,							"20 pistol ammo",				nil,									"ammo_pistol",						function(pl) pl:GiveAmmo(20, "pistol", true) end)
GM:AddPointShopItem("pistolammo2",		ITEMCAT_AMMO,			20,				nil,							"80 pistol ammo",				nil,									"ammo_pistol",						function(pl) pl:GiveAmmo(80, "pistol", true) end)

GM:AddPointShopItem("shotgunammo",		ITEMCAT_AMMO,			5,				nil,							"16 shotgun ammo",				nil,									"ammo_shotgun",						function(pl) pl:GiveAmmo(16, "buckshot", true) end)
GM:AddPointShopItem("shotgunammo2",		ITEMCAT_AMMO,			20,				nil,							"64 shotgun ammo",				nil,									"ammo_shotgun",						function(pl) pl:GiveAmmo(64, "buckshot", true) end)

GM:AddPointShopItem("smgammo",			ITEMCAT_AMMO,			5,				nil,							"40 SMG ammo",					nil,									"ammo_smg",							function(pl) pl:GiveAmmo(40, "smg1", true) end)
GM:AddPointShopItem("smgammo2",			ITEMCAT_AMMO,			20,				nil,							"160 SMG ammo",					nil,									"ammo_smg",							function(pl) pl:GiveAmmo(160, "smg1", true) end)

GM:AddPointShopItem("rifleammo",		ITEMCAT_AMMO,			5,				nil,							"10 rifle ammo",				nil,									"ammo_rifle",						function(pl) pl:GiveAmmo(10, "357", true) end)
GM:AddPointShopItem("rifleammo2",		ITEMCAT_AMMO,			20,				nil,							"40 rifle ammo",				nil,									"ammo_rifle",						function(pl) pl:GiveAmmo(40, "357", true) end)

GM:AddPointShopItem("crossbowammo",		ITEMCAT_AMMO,			5,				nil,							"12 crossbow bolts",			nil,									"ammo_bolts",						function(pl) pl:GiveAmmo(12,	"XBowBolt",	true) end)
GM:AddPointShopItem("crossbowammo2",	ITEMCAT_AMMO,			20,				nil,							"48 crossbow bolts",			nil,									"ammo_bolts",						function(pl) pl:GiveAmmo(48,	"XBowBolt",	true) end)

GM:AddPointShopItem("assaultrifleammo",	ITEMCAT_AMMO,			5,				nil,							"36 assault rifle ammo",		nil,									"ammo_assault",						function(pl) pl:GiveAmmo(36, "ar2", true) end)
GM:AddPointShopItem("assaultrifleammo2",ITEMCAT_AMMO,			20,				nil,							"144 assault rifle ammo",		nil,									"ammo_assault",						function(pl) pl:GiveAmmo(144, "ar2", true) end)

GM:AddPointShopItem("pulseammo",		ITEMCAT_AMMO,			5,				nil,							"30 pulse ammo",				nil,									"ammo_pulse",						function(pl) pl:GiveAmmo(30, "pulse", true) end)
GM:AddPointShopItem("pulseammo2",		ITEMCAT_AMMO,			20,				nil,							"120 pulse ammo",				nil,									"ammo_pulse",						function(pl) pl:GiveAmmo(120, "pulse", true) end)

GM:AddPointShopItem("impactmine",		ITEMCAT_AMMO,			5,				nil,							"5 explosives",					nil,									"ammo_explosive",					function(pl) pl:GiveAmmo(5, "impactmine", true) end)
GM:AddPointShopItem("impactmine2",		ITEMCAT_AMMO,			20,				nil,							"20 explosives",				nil,									"ammo_explosive",					function(pl) pl:GiveAmmo(20, "impactmine", true) end)
...
GM:AddPointShopItem("25mkit2",			ITEMCAT_AMMO,			20,				nil,							"100 Medical Kit power",			"100 extra power for the Medical Kit.",	"ammo_medpower",					function(pl) pl:GiveAmmo(100, "Battery", true) end)

item =
GM:AddPointShopItem("nail",				ITEMCAT_AMMO,			1,				nil,							"1 Nail",							"It's just one nail.",					"ammo_nail",						function(pl) pl:GiveAmmo(1, "GaussEnergy", true) end)
item.NoClassicMode = true
item.CanMakeFromScrap = true
GM:AddPointShopItem("nail2",			ITEMCAT_AMMO,			8,				nil,							"12 Nails",							"Twelve Nails",					"ammo_nail",						function(pl) pl:GiveAmmo(12, "GaussEnergy", true) end)

item =
GM:AddPointShopItem("scrap",			ITEMCAT_AMMO,			20,				nil,							"10 scrap",			nil,									"ammo_scrap",					function(pl) pl:GiveAmmo(10, "scrap", true) end)
item.BannedFromRemantler = true
item =
GM:AddPointShopItem("scrap2",			ITEMCAT_AMMO,			100,			nil,							"50 scrap",			nil,									"ammo_scrap",					function(pl) pl:GiveAmmo(50, "scrap", true) end)
item.BannedFromRemantler = true
...
-- Tier 4
GM:AddPointShopItem("graveshvl",		ITEMCAT_MELEE,			130,			"weapon_zs_graveshovel")
GM:AddPointShopItem("kongol",			ITEMCAT_MELEE,			130,			"weapon_zs_kongolaxe")
GM:AddPointShopItem("scythe",			ITEMCAT_MELEE,			130,			"weapon_zs_scythe")
GM:AddPointShopItem("rebarmace",		ITEMCAT_MELEE,			130,			"weapon_zs_rebarmace")
-- Tier 5
GM:AddPointShopItem("frotchet",			ITEMCAT_MELEE,			300,			"weapon_zs_frotchet")
GM:AddPointShopItem("powerfists",		ITEMCAT_MELEE,			300,			"weapon_zs_powerfists")
...
GM:AddPointShopItem("arsenalcrate",		ITEMCAT_DEPLOYABLES,			25,				"weapon_zs_arsenalcrate").Countables = "prop_arsenalcrate"
GM:AddPointShopItem("resupplybox",		ITEMCAT_DEPLOYABLES,			25,				"weapon_zs_resupplybox").Countables = "prop_resupplybox"
GM:AddPointShopItem("remantler",		ITEMCAT_DEPLOYABLES,			25,				"weapon_zs_remantler").Countables = "prop_remantler"
...
item =
GM:AddPointShopItem("infturret",		ITEMCAT_DEPLOYABLES,			100,				"weapon_zs_turret_gun",			nil,							nil,									nil,											function(pl) pl:GiveEmptyWeapon("weapon_zs_turret_gun") pl:GiveAmmo(1, "turret_gun") end)
item.NoClassicMode = true
item.Countables = "prop_turret_gun"
item =
GM:AddPointShopItem("blastturret",		ITEMCAT_DEPLOYABLES,			200,				"weapon_zs_turret_buckshot",	nil,							nil,									nil,											function(pl) pl:GiveEmptyWeapon("weapon_zs_turret_buckshot") pl:GiveAmmo(1, "turret_buckshot") end)
item.Countables = "prop_turret_buckshot"
item.NoClassicMode = true
item =
GM:AddPointShopItem("assaultturret",	ITEMCAT_DEPLOYABLES,			320,			"weapon_zs_turret_assault",	nil,							nil,									nil,											function(pl) pl:GiveEmptyWeapon("weapon_zs_turret_assault") pl:GiveAmmo(1, "turret_assault") end)
item.NoClassicMode = true
item.Countables = "prop_turret_assault"
item =
GM:AddPointShopItem("rocketturret",		ITEMCAT_DEPLOYABLES,			320,			"weapon_zs_turret_rocket",	nil,							nil,									nil,											function(pl) pl:GiveEmptyWeapon("weapon_zs_turret_rocket") pl:GiveAmmo(1, "turret_rocket") end)
...
item.NoClassicMode = true
item =
GM:AddPointShopItem("repairfield_nanite",		ITEMCAT_DEPLOYABLES,			200,			"weapon_zs_repairfield_nanite",		nil,							nil,									nil,											function(pl) pl:GiveEmptyWeapon("weapon_zs_repairfield_nanite") pl:GiveAmmo(1, "repairfield_nanite") pl:GiveAmmo(200, "pulse") end)
item.Countables = "prop_repairfield_nanite"
item.NoClassicMode = true
item =
GM:AddPointShopItem("zapper",			ITEMCAT_DEPLOYABLES,			100,				"weapon_zs_zapper",				nil,							nil,									nil,											function(pl) pl:GiveEmptyWeapon("weapon_zs_zapper") pl:GiveAmmo(1, "zapper") pl:GiveAmmo(30, "pulse") end)
item.Countables = "prop_zapper"
item.NoClassicMode = true
item =
GM:AddPointShopItem("zapper_arc",		ITEMCAT_DEPLOYABLES,			320,			"weapon_zs_zapper_arc",			nil,							nil,									nil,											function(pl) pl:GiveEmptyWeapon("weapon_zs_zapper_arc") pl:GiveAmmo(1, "zapper_arc") pl:GiveAmmo(30, "pulse") end)
item.Countables = "prop_zapper_arc"
item.NoClassicMode = true
item.SkillRequirement = SKILL_TECH_OFFENSE_DEP_ZAPPER_ARC
item =
GM:AddPointShopItem("ffemitter",		ITEMCAT_DEPLOYABLES,			50,				"weapon_zs_ffemitter",			nil,							nil,									nil,											function(pl) pl:GiveEmptyWeapon("weapon_zs_ffemitter") pl:GiveAmmo(1, "slam") pl:GiveAmmo(30, "pulse") end)
item.Countables = "prop_ffemitter"
...
GM:AddPointShopItem("ring base",		ITEMCAT_TOOLS,			50,				"comp_ring")
...
GM:AddPointShopItem("strengthshot",		ITEMCAT_TOOLS,			25,				"weapon_zs_strengthshot")
GM:AddPointShopItem("medrifle",			ITEMCAT_TOOLS,			60,			"weapon_zs_medicrifle")
...
GM:AddPointShopItem("regenimplant1",	ITEMCAT_TRINKETS,		15,				"trinket_regenimplant1").SubCategory =							ITEMSUBCAT_TRINKETS_DEFENSIVE
-- Tier 3
...
GM:AddPointShopItem("powergauntlet",	ITEMCAT_TRINKETS,		40,				"trinket_powergauntlet").SubCategory =							ITEMSUBCAT_TRINKETS_MELEE
GM:AddPointShopItem("hemoadrenalii",	ITEMCAT_TRINKETS,		30,				"trinket_hemoadrenalii").SubCategory =							ITEMSUBCAT_TRINKETS_MELEE
GM:AddPointShopItem("sharpstone",		ITEMCAT_TRINKETS,		20,				"trinket_sharpstone").SubCategory =								ITEMSUBCAT_TRINKETS_MELEE
...
GM:AddPointShopItem("vertinhib",		ITEMCAT_TRINKETS,		20,				"trinket_vertinhib").SubCategory =								ITEMSUBCAT_TRINKETS_PERFORMANCE
...
GM:AddPointShopItem("charm_bat",		ITEMCAT_TRINKETS,		200,			"trinket_charm_bat").SubCategory =								ITEMSUBCAT_TRINKETS_SPECIAL
GM:AddPointShopItem("charm_cat",		ITEMCAT_TRINKETS,		300,			"trinket_charm_cat").SubCategory =								ITEMSUBCAT_TRINKETS_SPECIAL
...
GM:AddPointShopItem("bloodshot",		ITEMCAT_OTHER,			50,				"weapon_zs_bloodshotbomb")
--item =
--GM:AddPointShopItem("corruptedfragment",ITEMCAT_OTHER,			55,				"weapon_zs_corruptedfragment")
--item.NoClassicMode = true
--item.SkillRequirement = SKILL_U_CORRUPTEDFRAGMENT
item =
GM:AddPointShopItem("medcloud",			ITEMCAT_OTHER,			50,				"weapon_zs_mediccloudbomb")
item.SkillRequirement = SKILL_U_MEDICCLOUD
item =
...
GM:AddDeployableInfo("prop_repairfield_nanite",	"Nanite Repair Field Emitter",	"weapon_zs_repairfield_nanite")
...
GM:AddDeployableInfo("prop_turret_base", 		"Gun Turret",	 		"weapon_zs_turret_base")
GM:AddDeployableInfo("prop_turret_gun", 		"Gun Turret",	 		"weapon_zs_turret_gun")
GM:AddDeployableInfo("prop_turret_assault", 	"Assault Turret",	 	"weapon_zs_turret_assault")
GM:AddDeployableInfo("prop_turret_buckshot",	"Blast Turret",	 		"weapon_zs_turret_buckshot")
GM:AddDeployableInfo("prop_turret_rocket",		"Rocket Turret",	 	"weapon_zs_turret_rocket")
...
GM.WaveOneZombies = 0.13--math.Round(CreateConVar("zs_waveonezombies", "0.1", FCVAR_REPLICATED + FCVAR_ARCHIVE + FCVAR_NOTIFY, "The percentage of players that will start as zombies when the game begins."):GetFloat(), 2)
