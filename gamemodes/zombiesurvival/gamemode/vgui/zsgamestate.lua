...
function PANEL:Text3Paint()
	if MySelf:IsValid() then
		if MySelf:Team() == TEAM_UNDEAD then
			...
			if toredeem > 0 then
				draw.SimpleText(translate.Format("brains_eaten_x", MySelf:Frags().." / "..toredeem..", Score: ".. math.Round(MySelf:GetNWFloat("zscore"),0)), self.Font, 0, 0, COLOR_SOFTRED)
			else
			...
			draw.SimpleText("Points: ".. math.floor(MySelf:GetPoints()) .."  Score: ".. math.floor(MySelf:GetNWFloat("points")), self.Font, 0, 0, COLOR_SOFTRED)
		end
	end
