...
function meta:TryAssembleItem(component, heldclass)
	...
	if self:HasTrinket(string.Replace(tostring(desiassembly), "trinket_", "")) then
		self:CenterNotify(COLOR_RED, translate.ClientGet(self, "you_already_have_this_trinket"))
		return
	end
