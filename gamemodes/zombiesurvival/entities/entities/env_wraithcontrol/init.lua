...
function ENT:Think()
	...
	if owner:IsValid() and owner:IsPlayer() and owner:Alive() and owner:Team() == TEAM_UNDEAD and (owner:GetZombieClassTable().Name == "Wraith" or owner:GetZombieClassTable().Name == "Common Wraith" or owner:GetZombieClassTable().Name == "Greater Wraith" or owner:GetZombieClassTable().Name == "Vengeful Wraith" or owner:GetZombieClassTable().Name == "Tormented Wraith" or owner:GetZombieClassTable().Name == "Damned Wraith" or owner:GetZombieClassTable().Name == "Supreme Wraith") then
