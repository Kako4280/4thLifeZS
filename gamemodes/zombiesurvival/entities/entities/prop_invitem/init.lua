...
function ENT:GiveToActivator(activator, caller)
	...
	if itypecat == INVCAT_COMPONENTS and activator:HasInventoryItem(itype) then
		activator:CenterNotify(COLOR_RED, translate.ClientGet(activator, "you_already_have_this_component"))
		return
	end
