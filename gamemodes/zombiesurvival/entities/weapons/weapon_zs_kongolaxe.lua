...
GAMEMODE:AttachWeaponModifier(SWEP, WEAPON_MODIFIER_FIRE_DELAY, -0.03)
local branch = GAMEMODE:AddNewRemantleBranch(SWEP, 1, "Cracked Axe", "Savagely slices up zombies.", function(wept)
	wept.MeleeDamage = wept.MeleeDamage * 0.60
	wept.Primary.Delay = wept.Primary.Delay * 0.60
	wept.Bleed = true
end)
branch.Colors = {Color(255, 0, 50), Color(200, 0, 50), Color(180, 0, 75)}
branch.NewNames = {"Wild", "Demented", "Wretched"}
