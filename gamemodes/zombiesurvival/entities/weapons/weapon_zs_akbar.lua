...
local branch = GAMEMODE:AddNewRemantleBranch(SWEP, 1, "Witherer", "Special bullets leave zombies bleeding.", function(wept)
	wept.Primary.Damage = wept.Primary.Damage * 0.80
	wept.Bleed = true
end)
