...
GAMEMODE:AddNewRemantleBranch(SWEP, 1, "'Servitor' Pulse Rifle", "Refreshes zapper cooldown on kill, reduced base damage, reduced accuracy and reload speed", function(wept)
