...
SWEP.BleedDamage = 0
SWEP.Pulse = false
SWEP.PulseStrength = 0
SWEP.Electric = false
SWEP.ElectricStrength = 1
SWEP.ElectricChance = 0
SWEP.Burn = false
SWEP.BurnDamage = 0
SWEP.BurnChance = 0
SWEP.BurnDurationMin = 0
SWEP.BurnDurationMax = 0
SWEP.Cold = false
SWEP.ColdStrength = 0
...
function SWEP.BulletCallback(attacker, tr, dmginfo, inf)
	...
	inf.BulletCallbackEcho(attacker, tr, dmginfo, inf)
end
