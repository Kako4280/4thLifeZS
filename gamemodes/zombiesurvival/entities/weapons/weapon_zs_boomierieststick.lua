...
SWEP.PrintName = "Boomieriest Stick"
...
GAMEMODE:AddNewRemantleBranch(SWEP, 1, "Litheieriest Stick", "Decreased damage but faster reload, more knockback and more move speed", function(wept)
