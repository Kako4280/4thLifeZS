...
function SWEP:CalcViewModelView(vm, oldpos, oldang, pos, ang)
	...
	if GAMEMODE.EnableCustomViewModelPosition == true then	
	    if GAMEMODE.ViewModelPosition then
		   pos = pos + ang:Right() * -GAMEMODE.ViewModelPosition, ang
		   pos = pos + ang:Forward() * GAMEMODE.ViewModelPosition2, ang
		   pos = pos + ang:Up() * GAMEMODE.ViewModelPositionUp, ang
		   pos = pos + ang:Up() * -GAMEMODE.ViewModelPositionDown, ang
	    end
	end
