...
local branch = GAMEMODE:AddNewRemantleBranch(SWEP, 2, "'Relampago' M4", "An M4 that has harnassed Tesla's wrath.", function(wept)
	wept.Primary.Damage = wept.Primary.Damage * 0.85
	wept.Electric = true
	wept.ElectricStrength = 0.5
	wept.ElectricChance = 0.35
end)
