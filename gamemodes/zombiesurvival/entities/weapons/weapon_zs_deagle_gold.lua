...
SWEP.Slot = 1
SWEP.SlotPos = 0
SWEP.Material = "models/weapons/deagle_gold"
...
if CLIENT then
	...
	function SWEP:PostDrawViewModel(mdl)
		mdl:SetMaterial("models/weapons/deagle_gold")
	end
	
	-- local asdf = ClientsideModel(SWEP.WorldModel)
	-- asdf:SetMaterial("models/weapons/deagle_gold")
end
