...
local colWhitelol = Color(220, 220, 220, 230)
...
function SWEP:Draw2DHUD()
	...
	if self:GetElementalState() == 0 then
		draw.SimpleTextBlurry("Pulse", "ZSHUDFont", x + wid * 0.5, yy, colWhitelol, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
	elseif self:GetElementalState() == 1 then
		draw.SimpleTextBlurry("Ice", "ZSHUDFont", x + wid * 0.5, yy, colWhitelol, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
	elseif self:GetElementalState() == 2 then
		draw.SimpleTextBlurry("Fire", "ZSHUDFont", x + wid * 0.5, yy, colWhitelol, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
	elseif self:GetElementalState() == 3 then
		draw.SimpleTextBlurry("Acid", "ZSHUDFont", x + wid * 0.5, yy, colWhitelol, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
	end
end
...
function SWEP:Draw3DHUD(vm, pos, ang)
	...
	cam.Start3D2D(pos, ang, self.HUD3DScale / 2)
		...
		if self:GetElementalState() == 0 then
			draw.SimpleTextBlurry("Pulse", "ZSHUDFont", x + wid * 0.5, y - hei * 1.5, colWhitelol, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
		elseif self:GetElementalState() == 1 then
			draw.SimpleTextBlurry("Ice", "ZSHUDFont", x + wid * 0.5, y - hei * 1.5, colWhitelol, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
		elseif self:GetElementalState() == 2 then
			draw.SimpleTextBlurry("Fire", "ZSHUDFont", x + wid * 0.5, y - hei * 1.5, colWhitelol, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
		elseif self:GetElementalState() == 3 then
			draw.SimpleTextBlurry("Acid", "ZSHUDFont", x + wid * 0.5, y - hei * 1.5, colWhitelol, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
		end
	cam.End3D2D()
end
