...
SWEP.PrintName = "PUNISHED Stick"
SWEP.Description = "PUNIIISHHHHEDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD."
...
SWEP.Primary.Projectile = "projectile_devourer"
...
GAMEMODE:AddNewRemantleBranch(SWEP, 1, "litheeeeeeeeeeeeedhasdjflhsa Stick", "Decreased damage but faster reload, more knockback and more move speed", function(wept)
