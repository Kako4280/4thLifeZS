...
local branch = GAMEMODE:AddNewRemantleBranch(SWEP, 1, "'Schizophrenia' SMG", "A 'Bullet Storm' SMG imbued with chaotic properties.", function(wept)
	wept.Primary.Damage = wept.Primary.Damage * 0.88
	...
	wept.Pulse = true
	wept.BleedDamage = 2
	wept.ElectricStrength = 0.3
	wept.ElectricChance = 0.08
	wept.BurnDamage = 3
	wept.BurnChance = 0.08
	wept.ColdStrength = 3
	wept.PulseStrength = 2
end)
branch.Colors = {Color(40, 0, 100), Color(125, 0, 100), Color(255, 0, 100)}
branch.NewNames = {"Impulsive", "Delusional", "Chaotic"}
