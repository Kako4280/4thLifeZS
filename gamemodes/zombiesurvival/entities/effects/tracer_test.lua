...
function EFFECT:Render()
	...
	for i = 0, 4 do
		render.DrawBeam(self.StartPos, self.EndPos, 609, texcoord, texcoord + nlen / 128, Color(120, 120, 255, 255 * alpha))
	end
	render.DrawBeam(self.StartPos, self.EndPos, 1998, texcoord, texcoord + nlen / 128, Color(150, 255, 255, 170 * alpha))
